...
export const TITLE_DEFAULT = '5irechain Staking Dashboard';
export const DAPP_NAME = '5irechain_staking_dashboard';
export const CERE_URL = 'https://5ire.org';
 ...
 */
export const MAX_NOMINATIONS = 100;
